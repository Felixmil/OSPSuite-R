...
- **[![Open System Pharmacology
  Logo](https://avatars.githubusercontent.com/u/25098323?s=33)Open
  Systems Pharmacology](https://www.open-systems-pharmacology.org/)**.
  Copyright holder, funder.

- **[Michael Sevestre](https://github.com/msevestre)**. Author,
  maintainer.

- **[Pavel Balazki](https://github.com/PavelBal)**. Author.
...
package to manipulate OSPSuite Models*. R package version 12.3.2.9006,
<https://github.com/open-systems-pharmacology/ospsuite-r>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 12.3.2.9006},
